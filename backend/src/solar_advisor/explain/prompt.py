...
_SYSTEM = (
    ...
    "- Refer to each time slot by its number (e.g. 'slot 3') or its time of day in plain "
    "words ('overnight', 'late afternoon'), never by clock digits. A confidence may be "
    "stated as a percentage (e.g. a confidence of 0.6 may be written '60%').\n"
