...
const points: HistoryPoint[] = [
  { ts: '2026-06-22T08:00:00+00:00', battery_soc: 60, pv_power: 0, grid_power: 100, load_power: 200, battery_power: 0 },
  { ts: '2026-06-22T09:00:00+00:00', battery_soc: 64, pv_power: 500, grid_power: 0, load_power: 300, battery_power: 0 },
]
...
it('produces no NaN in the polyline for an all-equal series', () => {
  const flat: HistoryPoint[] = [
    { ts: '2026-06-22T08:00:00+00:00', battery_soc: 50, pv_power: 0, grid_power: 0, load_power: 0, battery_power: 0 },
    { ts: '2026-06-22T09:00:00+00:00', battery_soc: 50, pv_power: 0, grid_power: 0, load_power: 0, battery_power: 0 },
    { ts: '2026-06-22T10:00:00+00:00', battery_soc: 50, pv_power: 0, grid_power: 0, load_power: 0, battery_power: 0 },
  ]
  const w = mount(TrendChart, {
